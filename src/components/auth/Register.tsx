    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200 relative" style={{ isolation: 'isolate' }}>
      ...
      >
        ...
        <GlassSurface
          ...
          brightness={65}
          opacity={0.9}
          style={{ maxWidth: '480px', minHeight: '600px' }}
        >
          <motion.form
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="preferRenewable" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 dark:border-gray-600 rounded"
                />
                <label htmlFor="autoTrade" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
